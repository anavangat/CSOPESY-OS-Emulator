...
void AddInstruction::execute(Process& process, SymbolTable& symbolTable) {
	...
	uint32_t result = static_cast<uint32_t>(value1) + static_cast<uint32_t>(value2); // Use uint32_t to handle potential overflow before clamping to 65535
